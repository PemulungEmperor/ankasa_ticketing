          ...
          <div className="col-md-6">
            ...
            <div className="col-md-5">
              ...
              <div className="row mt-2" style={{ "fontSize":"8px" }}>
                  <div className="col-md-6">
                    <p className="text-white">Monday, 20 July 20 <small className="ms-3">&#9679;</small></p>
                  </div>
                  <div className="col-md-4">
                  <p className="text-white">6 Passenger <small className="ms-3">&#9679;</small></p>
                  </div>
            ...
            <div className="col-md-3"><img src="/img/assyifa/set-icon.png" alt="" style={{ "visibility":"hidden" }} className="img-fluid"/></div>
          ...
          <div className="row">
            <div className="col-md-3">
              <div className="text1 d-flex justify-content-between mt-3">
                ...
                <h4
                  className="mt-2"
                  style={{ fontSize: '16px', color: '#2395FF' }}
                >
                  Reset
                </h4>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="d-flex mb-3">
                    ...
                    <i
                      className="fa-solid fa-angle-up ml-auto ms-auto"
                      style={{ color: '#2395FF' }}
                    ></i>
                  </div>
                  {/* Title End */}
                  ...
                  <div
                    className="lowest d-flex justify-content-between"
                    style={{ color: '#2395FF' }}
                  >
                    <p>$145,00</p>
                    <p>$300,00</p>
            ...
            <div className="col-md-9 mt-3">
              ...
              <div className="text9 d-flex justify-content-between">
                <div className="right-text d-flex mt-0">
                  ...
                  <p
                    className="ms-2 mt-2 text-muted"
                    style={{ fontSize: '14px' }}
                  >
                    (6 Flight Found)
                  </p>
                ...
                <small>
                  <p
                    className="d-flex text-right mt-2"
                    style={{ fontSize: '14px' }}
                  >
                    Sort by
              ...
              <div key={data.id} className="loopingCard mb-3">
                <div className="card-body d-flex w-100">
                  <div className="img d-flex">
                    <img src={"/img/flightLogo/"+data.photo_path} alt="" />
                ...
                <div className="row second-text d-flex">
                  ...
                  <div className="col-md-3 icons d-flex justify-content-center">
                    <div className="mt-3 mb-2 icon">
                      {
                        data.luggage ? <i
                        className="col-1 fa-solid fa-suitcase-rolling"
                        style={{ marginRight: '30px', color: '#979797' }}
                      ></i> : ''
                      }
                     {
                      data.meal ?  <i
                      className="col-1 fa-solid fa-burger"
                      style={{ marginRight: '30px', color: '#979797' }}
                    ></i> : ''
                     }
                      {
                        data.wifi ? <i
                        className="col-1 fa-solid fa-wifi"
                        style={{ color: '#979797' }}
                      ></i> : ''
                      }
                    </div>
                  ...
                  <div className="col-md-2 mt-2">
                    <Link to="/flight"
                      className="btn btn-primary btn-sm mb-4 w-100"
                      style={{ backgroundColor: '#2395FF', border: '0px' }}
                    >
                      Select
                    </Link>
                  </div>
